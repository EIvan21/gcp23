  ...
  - title: Total Sales Amount
    ...
    dynamic_fields: [{category: dimension, description: '', label: Enero, value_format: !!null '',
        ...
        args: [transactions.order_date, [!ruby/hash:ActiveSupport::HashWithIndifferentAccess {
              label: Enero, filter: 2023-01, __FILE: sales_edher/Dashboards/TestDashboard.dashboard.lookml,
              __LINE_NUM: 405}], !!null ''], _kind_hint: dimension, _type_hint: string}]
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
    show_y_axis_labels: true
    ...
    width:
    height:
  - title: esting long Tables
    name: esting long Tables
    model: gcp_sales_edher
    explore: transactions
    type: looker_grid
